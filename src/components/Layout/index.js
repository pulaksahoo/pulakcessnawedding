...
import Favicon from '../../assets/images/pulak.jpg';
...
function MainLayout({ children }) {
  return (
    <Fragment>
      <Helmet>
        <title>Pulak ❤️ Cessna Wedding</title>

        {/* Favicon */}
        <link rel="icon" type="image/png" href={Favicon} />

        {/* font and SEO tags */}
        <meta property="og:title" content="The Wedding of Pulak & Cessna" />
        <meta property="og:image" content={IMAGE_URL} />
        <meta property="og:url" content="https://thekusuma.com" />
        <meta property="og:site_name" content="The Wedding of Pulak & Cessna" />
        <meta property="og:description" content={META_DESCRIPTION} />
        <meta name="twitter:title" content="The Wedding of Pulak & Cessa" />
